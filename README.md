...
1. Go to your [project’s API settings on manage.sanity.io](https://manage.sanity.io/projects/2a0ablcf/settings/api) and create a token with read rights.
